...
our synthetic data is, by design, characterized by transient rapid
postseismic deformation in the first year after the earthquake,
resulting from afterslip, followed by steady deformation in the later
years, resulting from viscoelastic creep.  Surface deformation
following large ($\geq Mw=7$) earthquakes often is characterized by a
similar temporal evolution \citep[e.g.][]{SS1997,S2005,E2009,R2015},
and has also been described with a combination of afterslip and
relaxation in a Maxwell viscoelastic lithosphere
\citep[e.g.][]{PA2005,J2009}. Indeed, \citet{PA2005} descibed
postseismic deformation following the 2001 Mw=8.4 Peru earthquake by
assuming that the rate of deformation resulting from viscoelastic
relaxation was constant over their two year long time series, which is
the assumption that we make in our approximation for postseimic
deformation, although in our formulation in
eq. (\ref{Postseismic_Approximation}) we allow the rate of deformation
to scale with the fault slip history over the postseismic period.
This is suggestive that our approximation for early postseismic
deformation is appropriate on postseismic timescales.
...
surface displacements following the 2002 $Mw=7.9$ Denali earthquake
and the 1999 $Mw7.1$ Hector Mine earthquake.  In both cases the best
