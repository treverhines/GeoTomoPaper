...
demonstrated in figure 5, which shows $\bold{u}(t)$ and
$\bold{u}(t)_{\mathrm{true}}$ at a sample site near the fault.  The
...
the magnitude of the difference between $\bold{u}(t)$ and
$\bold{u}_{\mathrm{true}}(t)$ is smaller than the uncertainty on our synthetic
...
\end{equation}
Our imposed constraints on $f^{(n)}(t)$ ensure that
...
\bibitem[\textit{Hirth \& Kohlstedt}(2003)]{HK2003} Hirth, G. \&
...
\bibitem[\textit{Ergintav et al.}(2009)]{E2009} Ergintav, S.,
...
\bibitem[\textit{Freed et al.}(2006b)]{F2006b} Freed, A.M.,
...
\bibitem[\textit{Freed et al.}(2006a)]{F2006} Freed, A.M., B\"urgmann,
